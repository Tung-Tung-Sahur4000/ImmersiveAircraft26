...
public class VehicleScreen extends AbstractContainerScreen<VehicleScreenHandler> {
    ...
    public VehicleScreen(VehicleScreenHandler handler, Inventory inventory, Component title) {
        // imageWidth/imageHeight are final in 26.1 and must go through super().
        super(handler, inventory, title, DEFAULT_IMAGE_WIDTH,
                BASE_HEIGHT + handler.getVehicle().getInventoryDescription().getHeight() + TITLE_HEIGHT * 2);
